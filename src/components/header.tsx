                  ...
                  <div className="right-dropbox-list" style={{ zIndex: "100" }}>
                    ...
                    <div className="nav-dropbox-list-right">
                      ...
                      <div className="row-gap-8">
                        ...
                        >
                          <div className="dropdown-link-item-left-first">
                            <img src={voiceofcustomer} width={33} />
                          </div>
                        ...
                        >
                          <div className="dropdown-link-item-left-first">
                            <img src={customerexperience} width={30} />
                          </div>
                ...
                >
                  <div className="dropbox-list" style={{ zIndex: "100" }}>
                    ...
                    >
                      <div className="left-item-container">
                        <div className="dropdown-link-item-left-secondary">
                          <img src={canva} width={20} height={"auto"} />
                        </div>
                        <div>
                          <div className="nav-link font-weight-700">Canva</div>
                        </div>
                      </div>
                      <img src={arrow_right} height={12} width={"auto"} />
                    </a>
                    ...
                    >
                      <div className="left-item-container">
                        <div className="dropdown-link-item-left-secondary">
                          <img src={notion} width={20} height={"auto"} />
                        </div>
                        <div>
                    ...
                    >
                      <div className="left-item-container">
                        <div className="dropdown-link-item-left-secondary">
                          <img src={apollo} width={20} height={"auto"} />
                        </div>
                        <div>
                    ...
                    >
                      <div className="left-item-container">
                        <div className="dropdown-link-item-left-secondary">
                          <img src={figma} width={20} height={"auto"} />
                        </div>
                        <div>
                    ...
                    >
                      <div className="left-item-container">
                        <div className="dropdown-link-item-left-secondary">
                          <img src={feeld} width={20} height={"auto"} />
                        </div>
                        <div>
                    ...
                    >
                      <div className="left-item-container">
                        <div className="dropdown-link-item-left-secondary">
                          <img src={bollandbranch} width={20} height={"auto"} />
                        </div>
                        <div>
                          <div
                            className="nav-link font-weight-700"
                ...
                >
                  <div className="dropbox-list" style={{ zIndex: "100" }}>
                    ...
                    >
                      <div className="left-item-container">
                        <div className="dropdown-link-item-left-secondary">
                          <img src={blog} width={30} height={"auto"} />
                        </div>
                        <div>
                    ...
                    >
                      <div className="left-item-container">
                        <div className="dropdown-link-item-left-secondary">
                          <img src={templates} width={20} height={"auto"} />
                        </div>
                        <div>
                          <div className="nav-link font-weight-700">
                            Templates
                    ...
                    >
                      <div className="left-item-container">
                        <div className="dropdown-link-item-left-secondary">
                          <img src={aboutus} width={20} height={"auto"} />
                        </div>
                        <div>
                          <div className="nav-link font-weight-700">
                            About us
                    ...
                    >
                      <div className="left-item-container">
                        <div className="dropdown-link-item-left-secondary">
                          <img src={press} width={25} height={"auto"} />
                        </div>
                        <div>
